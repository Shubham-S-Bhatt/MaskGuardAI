/**
  ******************************************************************************
  * @file    facemaskdetectionstm32f407tflite.c
...
#include "facemaskdetectionstm32f407tflite.h"
...
#define AI_NET_OBJ_INSTANCE g_facemaskdetectionstm32f407tflite
 
#undef AI_FACEMASKDETECTIONSTM32F407TFLITE_MODEL_SIGNATURE
#define AI_FACEMASKDETECTIONSTM32F407TFLITE_MODEL_SIGNATURE     "bb2b74de511a357e61b22e40910914a4"
...
#define AI_TOOLS_DATE_TIME   "Thu Mar 25 22:15:47 2021"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_FACEMASKDETECTIONSTM32F407TFLITE_N_BATCHES
#define AI_FACEMASKDETECTIONSTM32F407TFLITE_N_BATCHES         (1)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 12200, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_FACEMASKDETECTIONSTM32F407TFLITE_IN_NUM, &conv2d_2_input_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_FACEMASKDETECTIONSTM32F407TFLITE_OUT_NUM, &nl_7_output),
  &conv2d_0_layer, 0, NULL)



AI_DECLARE_STATIC
ai_bool facemaskdetectionstm32f407tflite_configure_activations(
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_2_input_output_array.data = AI_PTR(NULL);
    conv2d_2_input_output_array.data_start = AI_PTR(NULL);
    conv2d_0_output_array.data = AI_PTR(activations + 7360);
    conv2d_0_output_array.data_start = AI_PTR(activations + 7360);
    conv2d_2_output_array.data = AI_PTR(activations + 3360);
    conv2d_2_output_array.data_start = AI_PTR(activations + 3360);
...
AI_DECLARE_STATIC
ai_bool facemaskdetectionstm32f407tflite_configure_weights(
  ...
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_FACEMASKDETECTIONSTM32F407TFLITE_MODEL_NAME,
      .model_signature   = AI_FACEMASKDETECTIONSTM32F407TFLITE_MODEL_SIGNATURE,
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= facemaskdetectionstm32f407tflite_configure_weights(net_ctx, &params->params);
  ok &= facemaskdetectionstm32f407tflite_configure_activations(net_ctx, &params->activations);
...
AI_API_ENTRY
ai_i32 ai_facemaskdetectionstm32f407tflite_forward(ai_handle network, const ai_buffer* input)
{
